...
using Trips.Services.Implementations;
...
namespace Trips
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITripsDbService, TripsDbService>();
            services.AddTransient<IClientsDbService, ClientsDbService>();

            services.AddDbContext<TripsContext>(opt =>
            {
